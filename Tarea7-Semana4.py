def menu():
    print("App de consulta")
    print("")
    print("Con esta app puede:")
    print("")
...
def Consultar_Cabecera():
    ...
    if Cabecera in Departamento:
        ...
        print("") 
        print("Lo siento, ha cometido un error, el nombre del departamento:", Cabecera, "fue escrito de manera incorrecta, por favor, intentelo de nuevo.")
        print("")
        print("Asegúrese de colocar la tilde, de lo contrario, no podrá realizar la consulta")
        print("")
        menu()
    menu()
